...
REST_AUTH = {
    "USE_JWT": True,
    "USER_DETAILS_SERIALIZER": "spm.users.api.v1.serializers.UserProfileSerializer",
...
AUTHENTICATION_ADDITIONAL_FIELDS = ["email"]
AUTHENTICATION_FIELDS = ["username"] + AUTHENTICATION_ADDITIONAL_FIELDS
